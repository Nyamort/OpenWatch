...
class BuildNotificationIndexData
{
    ...
    public function handle(
        ...
        $notifications = $this->fetchNotifications($envId, $start, $end, $sort, $direction, $search, $page);
     ...
     * @return array<string, mixed>
     */
    private function fetchNotifications(int $envId, string $start, string $end, string $sort, string $direction, string $search, int $page): array
    {
        $baseWhere = "WHERE environment_id = {$envId}
            AND recorded_at BETWEEN {$start} AND {$end}";
