...
import type { JobTypeGraphBucket, JobTypeStats } from '../types';
...
interface JobTypeChartsProps {
    graph: JobTypeGraphBucket[];
    stats: JobTypeStats;
}

export function JobTypeCharts({ graph, stats }: JobTypeChartsProps) {
    const attemptsStats = (
