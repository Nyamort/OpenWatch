...
export function CommandTable({ commands, pagination, sort, direction, search }: CommandTableProps) {
    ...
    function handleSearch(value: string) {
        ...
        debounceRef.current = setTimeout(() => {
            ...
            router.get(urlObj.pathname + urlObj.search, {}, { preserveScroll: true, preserveState: true, only: ['commands', 'pagination', 'sort', 'direction', 'search'] });
        }, 300);
    }
    ...
    function handlePage(page: number) {
        ...
        router.get(urlObj.pathname + urlObj.search, {}, { preserveScroll: true, preserveState: true, only: ['commands', 'pagination', 'sort', 'direction'] });
    }
    ...
    const onSort = (col: string) => handleSort(col as CommandSortKey);
