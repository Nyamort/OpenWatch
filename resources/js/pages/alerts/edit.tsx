...
export default function EditAlertRule({ organization, project, environment, alertRule, members }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Edit Alert Rule', href: '#' }]}>
            ...
            <div className="p-6 max-w-lg">
                <h1 className="text-xl font-semibold mb-4">Edit Alert Rule</h1>
                <form onSubmit={e => { e.preventDefault(); patch(baseUrl); }}>
                    <div className="mb-4">
