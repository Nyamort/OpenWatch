...
export function WizardStep4({
    ...
    return (
        <div className="mt-4 space-y-4">
            <div>
                <p className="text-xs font-semibold text-zinc-400 mb-2">Run the Nightwatch Agent</p>
            ...
            <div
                className={cn(
                    ...
                    connected ? 'border-emerald-800 bg-emerald-950/40' : 'border-zinc-700 bg-zinc-900',
                )}
            >
                <span className="text-xs font-bold uppercase tracking-wider text-zinc-500">Connection</span>
            ...
            <div className="flex justify-between">
                ...
                <div className="flex gap-2">
                    <Button variant="ghost" onClick={onSkip} className="text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800">
                        Skip
                    </Button>
