    ...
    return (
        <div className="mt-4 space-y-4">
            <p className="text-sm text-zinc-400">
                Sampling reduces the number of events Nightwatch records, helping control storage and performance
                costs. We recommend starting at{' '}
                <span className="text-zinc-200 font-medium">10%</span> for requests and adjusting based on your
                traffic.
            </p>
            ...
            <div className="flex items-center gap-2 rounded-md border border-blue-800 bg-blue-950/40 px-3 py-2">
                ...
                <span className="text-xs text-blue-300">Learn more about additional sampling options</span>
            </div>
