    ...
    return (
        <div className="grid min-h-svh lg:grid-cols-2">
            ...
            <div className="relative hidden flex-col overflow-hidden bg-zinc-950 lg:flex">
                ...
                <div className="absolute right-0 bottom-0 size-[400px] rounded-full bg-white/3 blur-3xl" />
                ...
                <div className="relative flex h-full flex-col p-12">
                    ...
                    <div className="mt-auto">
                        ...
                        <h1
                            className={`text-4xl font-semibold tracking-tight text-white ${eyebrow ? 'mt-3' : ''}`}
                        >
                            {headline ?? (
                                <>
                                    Monitor your{' '}
                        ...
                        <p className="mt-4 max-w-sm text-base leading-relaxed text-white/50">
                            {subHeadline ??
                                'Gain full visibility into errors, performance, and behaviour across all your environments.'}
                        </p>
